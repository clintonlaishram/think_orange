  ...
  return (
    <div className={className}>
      ...
      <div
        ...
        tabIndex={-1}
        // The panel stays mounted so it can slide in and out, which means its
        // links are in the DOM while it is off-screen. Without `inert` a
        // keyboard user tabs straight off the logo into invisible content —
        // the classic off-canvas trap. `inert` removes the whole subtree from
        // the tab order, the a11y tree and pointer events in one attribute.
        inert={!open}
        className={cn(
